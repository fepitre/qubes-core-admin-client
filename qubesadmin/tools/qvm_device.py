...
def prepare_table(dev_list):
    ...
    for line in dev_list:
        output += [(line.ident, line.description, str(line.assignments))]
...
class DeviceAction(qubesadmin.tools.QubesAction):
    ...
    def __init__(
        self,
        help="A backend & device id combination",
        required=True,
        allow_unknown=False,
        **kwargs
    ):
        ...
        super(DeviceAction, self).__init__(
    ...
    def parse_qubes_app(self, parser, namespace):
        ...
        try:
            ...
            try:
                ...
                if not self.allow_unknown and isinstance(
                    dev, qubesadmin.devices.UnknownDevice
                ):
