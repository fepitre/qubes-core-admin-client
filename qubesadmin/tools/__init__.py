...
class QubesAction(argparse.Action):
    """ Interface providing a convenience method to be called, after
...
class PropertyAction(argparse.Action):
    ...
    def __init__(
        ...
        super(PropertyAction, self).__init__(
...
class SinglePropertyAction(argparse.Action):
    ...
    def __init__(
        ...
        super(SinglePropertyAction, self).__init__(
            option_strings,
            "properties",
            metavar=metavar,
            help=help,
...
class VmNameAction(QubesAction):
    ...
    def __init__(
        ...
        super(VmNameAction, self).__init__(
...
class VolumeAction(QubesAction):
    ...
    def __init__(
        ...
        # pylint: disable=redefined-builtin
        super(VolumeAction, self).__init__(
...
class VMVolumeAction(QubesAction):
    ...
    def __init__(
        ...
        # pylint: disable=redefined-builtin
        super(VMVolumeAction, self).__init__(
            help=help, required=required, **kwargs
        )
