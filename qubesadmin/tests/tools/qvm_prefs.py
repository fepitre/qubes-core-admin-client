...
class TC_00_qvm_prefs(qubesadmin.tests.QubesTestCase):
    def test_000_list(self):
        ...
        with qubesadmin.tests.tools.StdoutBuffer() as stdout:
            self.assertEqual(
                0, qubesadmin.tools.qvm_prefs.main(["dom0"], app=self.app)
            )
        self.assertEqual(
        ...
        self.assertEqual(stdout.getvalue(), "prop2  -  value2\n")
    ...
    def test_001_no_vm(self):
        ...
        if sys.version_info[0] == 2:
            ...
            self.assertIn(
                "error: the following arguments are required: VMNAME",
                stderr.getvalue(),
            )
        self.assertAllCalled()
    ...
    def test_003_invalid_property(self):
        ...
        self.assertIn("no such property: 'no_such_property'", stderr.getvalue())
        self.assertAllCalled()
