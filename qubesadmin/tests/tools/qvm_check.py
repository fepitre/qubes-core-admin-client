...
class TC_00_qvm_check(qubesadmin.tests.QubesTestCase):
    ...
    def test_001_exists_multi(self):
        ...
        self.assertEqual(
            qubesadmin.tools.qvm_check.main(
    ...
    def test_003_exists_multi_verbose(self):
        ...
        with self.assertLogs() as logger:
            ...
            self.assertEqual(
                logger.output,
                [
                    "INFO:qvm-check:other-vm: exists",
    ...
    def test_005_running_multi_verbose(self):
        ...
        with self.assertLogs() as logger:
            self.assertEqual(
                qubesadmin.tools.qvm_check.main(
                    ["--running", "some-vm", "some-vm2"], app=self.app
                ),
                0,
            )
            self.assertEqual(
                logger.output,
                [
                    "INFO:qvm-check:some-vm: running",
    ...
    def test_009_paused_multi(self):
        ...
        with self.assertLogs() as logger:
            self.assertEqual(
                qubesadmin.tools.qvm_check.main(
                    ["--paused", "some-vm2", "some-vm"], app=self.app
                ),
                3,
            )
            self.assertEqual(logger.output, ["INFO:qvm-check:some-vm2: paused"])
    ...
    def test_010_template(self):
        ...
        with self.assertLogs() as logger:
            self.assertEqual(
                qubesadmin.tools.qvm_check.main(
                    ["--template", "some-vm3"], app=self.app
                ),
                0,
            )
            self.assertEqual(
                logger.output, ["INFO:qvm-check:some-vm3: template"]
            )
        self.assertAllCalled()
    ...
    def test_011_template_multi(self):
        ...
        with self.assertLogs() as logger:
            self.assertEqual(
                qubesadmin.tools.qvm_check.main(
                    ["--template", "some-vm2", "some-vm3"], app=self.app
                ),
                3,
            )
            self.assertEqual(
    ...
    def test_012_networked(self):
        ...
        with self.assertLogs() as logger:
            self.assertEqual(
                qubesadmin.tools.qvm_check.main(
                    ["--networked", "some-vm2"], app=self.app
                ),
                0,
            )
            self.assertEqual(
                logger.output, ["INFO:qvm-check:some-vm2: networked"]
            )
        self.assertAllCalled()
    ...
    def test_013_networked_multi(self):
        ...
        with self.assertLogs() as logger:
            self.assertEqual(
                qubesadmin.tools.qvm_check.main(
                    ["--networked", "some-vm2", "some-vm3"], app=self.app
                ),
                3,
            )
            self.assertEqual(
