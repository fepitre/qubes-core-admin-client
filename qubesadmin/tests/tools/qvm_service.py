...
class TC_00_qvm_service(qubesadmin.tests.QubesTestCase):
    def test_000_list(self):
        ...
        with qubesadmin.tests.tools.StdoutBuffer() as stdout:
            self.assertEqual(
                qubesadmin.tools.qvm_service.main(["some-vm"], app=self.app), 0
            )
            self.assertEqual(
    ...
    def test_002_enable(self):
        ...
        self.app.expected_calls[
            ("some-vm", "admin.vm.feature.Set", "service.service1", b"1")
        ] = b"0\x00"
        self.assertEqual(
            qubesadmin.tools.qvm_service.main(
                ["some-vm", "service1", "on"], app=self.app
            ),
            0,
        )
        self.assertAllCalled()
    ...
    def test_003_enable_opt(self):
        ...
        self.assertEqual(
            qubesadmin.tools.qvm_service.main(
                ["--enable", "some-vm", "service1"], app=self.app
            ),
            0,
        )
        self.assertAllCalled()
    ...
    def test_004_enable_opt_mixed(self):
        ...
        with self.assertNotRaises(SystemExit):
            self.assertEqual(
                qubesadmin.tools.qvm_service.main(
                    ["some-vm", "--enable", "service1"], app=self.app
                ),
                0,
            )
        self.assertAllCalled()
    ...
    def test_005_disable(self):
        ...
        self.app.expected_calls[
            ("some-vm", "admin.vm.feature.Set", "service.service1", b"")
        ] = b"0\x00"
        self.assertEqual(
            qubesadmin.tools.qvm_service.main(
                ["some-vm", "service1", "off"], app=self.app
            ),
            0,
        )
        self.assertAllCalled()
    ...
    def test_006_disable_opt(self):
        ...
        with self.assertNotRaises(SystemExit):
            self.assertEqual(
                qubesadmin.tools.qvm_service.main(
                    ["--disable", "some-vm", "service1"], app=self.app
                ),
                0,
            )
        self.assertAllCalled()
    ...
    def test_007_get(self):
        ...
        with qubesadmin.tests.tools.StdoutBuffer() as stdout:
            self.assertEqual(
                qubesadmin.tools.qvm_service.main(
                    ["some-vm", "service3"], app=self.app
                ),
                0,
            )
            self.assertEqual(stdout.getvalue(), "on\n")
        self.assertAllCalled()
    ...
    def test_008_del(self):
        ...
        with qubesadmin.tests.tools.StdoutBuffer() as stdout:
            self.assertEqual(
                qubesadmin.tools.qvm_service.main(
                    ["--unset", "some-vm", "srv4"], app=self.app
                ),
                0,
            )
    ...
    def test_009_del_legacy(self):
        ...
        with qubesadmin.tests.tools.StdoutBuffer() as stdout:
            self.assertEqual(
                qubesadmin.tools.qvm_service.main(
                    ["--default", "some-vm", "srv4"], app=self.app
                ),
                0,
            )
            self.assertEqual(stdout.getvalue(), "")
    ...
    def test_010_set_invalid(self):
        ...
        with self.assertRaises(SystemExit):
            qubesadmin.tools.qvm_service.main(
                ["some-vm", "service1", "invalid-value"], app=self.app
            ),
        self.assertAllCalled()
