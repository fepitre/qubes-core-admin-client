...
class TC_00_qvm_volume(qubesadmin.tests.QubesTestCase):
    ...
    def test_000_list(self):
        ...
        with qubesadmin.tests.tools.StdoutBuffer() as stdout:
            self.assertEqual(
                0, qubesadmin.tools.qvm_volume.main(["ls"], app=self.app)
            )
        self.assertEqual(
            stdout.getvalue(),
    ...
    def test_001_list_domain(self):
        ...
        with qubesadmin.tests.tools.StdoutBuffer() as stdout:
            self.assertEqual(
                0, qubesadmin.tools.qvm_volume.main(["ls", "vm1"], app=self.app)
            )
        self.assertEqual(
            stdout.getvalue(),
        ...
        with qubesadmin.tests.tools.StdoutBuffer() as stdout:
            self.assertEqual(
                ...
                qubesadmin.tools.qvm_volume.main(
                    ["ls", "-p", "pool-file", "vm1"], app=self.app
                ),
            )
        self.assertEqual(
            stdout.getvalue(),
    ...
    def test_005_list_default_action(self):
        ...
        with qubesadmin.tests.tools.StdoutBuffer() as stdout:
            self.assertEqual(
                0, qubesadmin.tools.qvm_volume.main([], app=self.app)
            )
        self.assertEqual(
            stdout.getvalue(),
            "POOL:VOLUME                 VMNAME   VOLUME_NAME  "
    ...
    def test_010_extend(self):
        ...
        self.assertEqual(
            0,
            qubesadmin.tools.qvm_volume.main(
                ["extend", "testvm:private", "10GiB"], app=self.app
            ),
        )
        self.assertAllCalled()
    ...
    def test_012_extend_deny_shrink(self):
        ...
        with qubesadmin.tests.tools.StderrBuffer() as stderr:
            self.assertEqual(
                1,
                qubesadmin.tools.qvm_volume.main(
                    ["resize", "testvm:private", "1GiB"], app=self.app
                ),
            )
    ...
    def test_013_resize_force_shrink(self):
        ...
        self.assertEqual(
            0,
            qubesadmin.tools.qvm_volume.main(
                ["resize", "-f", "testvm:private", "1GiB"], app=self.app
            ),
        )
        self.assertAllCalled()
    ...
    def test_020_revert(self):
        ...
        self.assertEqual(
            0,
            qubesadmin.tools.qvm_volume.main(
                ["revert", "testvm:private"], app=self.app
            ),
        )
        self.assertAllCalled()
    ...
    def test_023_revert_specific(self):
        ...
        self.assertEqual(
            0,
            qubesadmin.tools.qvm_volume.main(
                ["revert", "testvm:private", "20050101"], app=self.app
            ),
        )
        self.assertAllCalled()
    ...
    def test_030_set_revisions_to_keep(self):
        ...
        self.app.expected_calls[
            ("testvm", "admin.vm.volume.Set.revisions_to_keep", "private", b"3")
        ] = b"0\x00"
        self.assertEqual(
            0,
            qubesadmin.tools.qvm_volume.main(
    ...
    def test_031_set_rw(self):
        ...
        self.app.expected_calls[
            ("testvm", "admin.vm.volume.Set.rw", "private", b"True")
        ] = b"0\x00"
        self.assertEqual(
            0,
            qubesadmin.tools.qvm_volume.main(
                ["set", "testvm:private", "rw", "True"], app=self.app
            ),
        )
        self.assertAllCalled()
    ...
    def test_032_set_invalid(self):
        ...
        self.assertNotEqual(
            0,
            qubesadmin.tools.qvm_volume.main(
                ["set", "testvm:private", "invalid", "True"], app=self.app
            ),
        )
        self.assertAllCalled()
    ...
    def test_040_info(self):
        ...
        with qubesadmin.tests.tools.StdoutBuffer() as stdout:
            self.assertEqual(
                0,
                qubesadmin.tools.qvm_volume.main(
                    ["info", "testvm:private"], app=self.app
                ),
            )
    ...
    def test_042_info_single_prop(self):
        ...
        with qubesadmin.tests.tools.StdoutBuffer() as stdout:
            self.assertEqual(
                0,
                qubesadmin.tools.qvm_volume.main(
                    ["info", "testvm:root", "usage"], app=self.app
                ),
            )
    ...
    def test_043_info_revisions_only(self):
        ...
        with qubesadmin.tests.tools.StdoutBuffer() as stdout:
            self.assertEqual(
                0,
                qubesadmin.tools.qvm_volume.main(
                    ["info", "testvm:private", "revisions"], app=self.app
                ),
            )
        self.assertEqual(
            stdout.getvalue(),
    ...
    def test_050_import_file(self):
        ...
        with tempfile.NamedTemporaryFile() as input_file:
            ...
            self.assertEqual(
                0,
                qubesadmin.tools.qvm_volume.main(
                    ["import", "testvm:private", input_file.name], app=self.app
                ),
            )
        self.assertAllCalled()
        ...
        with tempfile.NamedTemporaryFile() as input_file:
            ...
            with unittest.mock.patch("sys.stdin") as mock_stdin:
                ...
                self.assertEqual(
                    0,
                    qubesadmin.tools.qvm_volume.main(
                        ["import", "testvm:private", "-"], app=self.app
                    ),
                )
        self.assertAllCalled()
