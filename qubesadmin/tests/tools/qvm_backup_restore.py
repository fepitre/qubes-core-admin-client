...
class TC_00_qvm_backup_restore(qubesadmin.tests.QubesTestCase):
    ...
    def test_000_simple(self, mock_backup, mock_getpass, mock_input):
        ...
        vm1.label = "red"
        mock_restore_info = {1: BackupRestore.VMToRestore(vm1)}
        ...
        with mock.patch(
            ...
            qubesadmin.tools.qvm_backup_restore.main(
                ["/some/path"], app=self.app
            )
    ...
    def test_001_selected_vms(self, mock_backup, mock_getpass, mock_input):
        ...
        qubesadmin.tools.qvm_backup_restore.main(
            ["/some/path", "test-vm"], app=self.app
        )
        mock_backup.assert_called_once_with(
            self.app,
            "/some/path",
        ...
        if action == "skip_broken":
            ...
            expected_calls.append(
                mock.call.warning(
                    ...
                    "{}s will have default value assigned.".format(missing_name)
                )
            )
