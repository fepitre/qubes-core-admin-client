...
class TC_00_qvm_pool(qubesadmin.tests.QubesTestCase):
    def test_000_list(self):
        ...
        with qubesadmin.tests.tools.StdoutBuffer() as stdout:
            self.assertEqual(
                0, qubesadmin.tools.qvm_pool.main(["-l"], app=self.app)
            )
        self.assertEqual(
            stdout.getvalue(),
            "NAME       DRIVER\n" "pool-file  file\n" "pool-lvm   lvm\n",
    ...
    def test_050_set(self):
        ...
        self.assertEqual(
            0,
            qubesadmin.tools.qvm_pool.main(
                ["-s", "pool-lvm", "-o", "revisions_to_keep=2"], app=self.app
            ),
        )
        self.assertAllCalled()
    ...
    def test_051_set_invalid(self):
        ...
        with self.assertRaises(SystemExit) as e:
            qubesadmin.tools.qvm_pool.main(
                ["-s", "pool-lvm", "-o", "prop=1"], app=self.app
            )
